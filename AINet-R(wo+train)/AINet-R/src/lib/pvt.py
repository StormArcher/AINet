...
class PolypPVT(nn.Module):
    def __init__(self, channel=32):
        ...
        path = '/data/home/scv1844/run/pre-train/pvt/pvt_v2_b2.pth'
    ...
    def initialize(self):
        self.load_state_dict(torch.load('/data/home/scv1844/run/pre-train/pvt/pvt_v2_b2.pth'), strict=False)


class PolypPVT2(nn.Module):
    def __init__(self, channel=32):
        super(PolypPVT2, self).__init__()

        self.backbone = pvt_v2_b2()  # [64, 128, 320, 512]
        path = '/data/home/scv1844/run/pre-train/pvt/pvt_v2_b2b.pth'
        save_model = torch.load(path)
        model_dict = self.backbone.state_dict()
        state_dict = {k: v for k, v in save_model.items() if k in model_dict.keys()}
        model_dict.update(state_dict)
    ...
    def initialize(self):
        self.load_state_dict(torch.load('/data/home/scv1844/run/pre-train/pvt/pvt_v2_b2b.pth'), strict=False)
